...
export function DocumentList() {
  ...
  const getStatusBadge = (status: Document['status']) => {
    const variants: Record<Document['status'], { icon: any; label: string; variant: any }> = {
      uploaded: { icon: Clock, label: 'Hochgeladen', variant: 'secondary' },
      processing: { icon: Clock, label: 'Wird verarbeitet', variant: 'default' },
      completed: { icon: CheckCircle, label: 'Abgeschlossen', variant: 'success' },
